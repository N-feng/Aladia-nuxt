<template>
  <main class="paid-course-landing-page__container" id="main-content-anchor">
      ...
      <div class="background-inner-position-container">
        <div class="">
          ...
          >
            ...
            >
              <a class="ud-heading-sm" href="/courses/development/">开发</a
              ><svg
                aria-hidden="true"
                focusable="false"
              ...
              ><a
                class="ud-heading-sm"
                href="/courses/development/programming-languages/"
                >编程语言</a
              ><svg
                aria-hidden="true"
                focusable="false"
              ...
              >
                <use xlink:href="#icon-next"></use></svg
              ><a class="ud-heading-sm" href="/topic/python/">Python</a>
            </div>
          </div>
          <div class="course-landing-page__introduction-asset__main">
            <div class="intro-asset--wrapper--yDCdR">
              <div class="asset">
                <button
                  type="button"
                  class="ud-btn ud-btn-large ud-btn-ghost ud-heading-md ud-custom-focus-visible placeholder"
                  aria-label="播放课程预览"
                >
                  <span class="img-aspect">
                    <img
                      src="https://img-c.udemycdn.com/course/240x135/567828_67d0.jpg"
                      srcset="
                        https://img-c.udemycdn.com/course/240x135/567828_67d0.jpg 240w,
                        https://img-c.udemycdn.com/course/480x270/567828_67d0.jpg 480w,
                        https://img-c.udemycdn.com/course/750x422/567828_67d0.jpg 750w
                      "
                      alt=""
                      style="
                  ...
                  <span class="ud-heading-md overlay text">预览本课程</span>
                </button>
              </div>
            </div>
          </div>
            ...
            <div class="ud-text-sm clp-lead">
              ...
              <div class="clp-lead__badge-ratings-enrollment">
                <div class="clp-lead__element-item clp-lead__element-item--row">
                  <a
                    href="#reviews"
                    class="ud-btn ud-btn-large ud-btn-link ud-heading-md ud-text-sm rating-wrapper"
                    data-purpose="rating"
                  >
                    <span class="star-wrapper medium">
                      <span class="ud-sr-only">评分：4.6，满分 5 分</span>
                      <span class="ud-heading-sm rating-number-1">4.6</span>
                      <svg
                        aria-hidden="true"
                        width="100%"
                        height="100%"
                      ...
                      >
                        ...
                        <g
                          class="star-filled"
                          mask="url(#u63-star-rating-mask--3)"
                ...
                >
                  <span class="names"
                    ...
                    <a
                      ...
                      data-position="1"
                      href="#instructor-1"
                      ><span class="ud-btn-label">Jose Portilla</span></a
                    >,
                    <a
                      class="ud-btn ud-btn-large ud-btn-link ud-heading-md ud-text-sm ud-instructor-links"
                      data-position="2"
                      href="#instructor-2"
                      ><span class="ud-btn-label">Pierian Training</span></a
                    ></span
                  >
                </div>
              </div>
              <div class="clp-lead__element-meta">
                <div class="clp-lead__element-item">
                  <div class="last-update-date" data-purpose="last-update-date">
                    ...
                    >
                      <use xlink:href="#icon-new"></use></svg
                    ><span>上次更新时间：2023/7</span>
                  </div>
                </div>
                <div
              ...
              >
                ...
                >
                      ...
                      >
                        <div>
                          <button
                            ...
                            class="ud-btn ud-btn-large ud-btn-primary ud-heading-md styles--btn--express-checkout--G4Ja4"
                          >
                            <span class="ud-btn-label">立即购买</span>
                          </button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="generic-purchase-section--local-incentive--4i-xF">
                    ...
                    >
                      <span class="money-back">30 天退款保证</span>
                    </div>
                  </div>
                  <div
                  ...
                  <div class="generic-purchase-section--local-incentive--4i-xF">
                    <div class="incentives--hide-on-tablet--LCtTD">
                      <div class="incentives--incentives-container--mJpmM">
                        ...
                        <ul
                          class="ud-unstyled-list ud-block-list incentive-list"
                        >
                          <li>
                            <div
                          ...
                          <li>
                            ...
                            >
                              ...
                              <div class="ud-block-list-item-content">
                                <span data-purpose="num-coding-exercises"
                                  >19 个代码练习</span
                                >
                              </div>
                            </div>
                  ...
                  <div class="generic-purchase-section--ctas--SQfIL">
                    ...
                    >
                      <div
                        class="generic-purchase-section--cta-multiple----iAg"
                      >
                        <button
                          type="button"
                        ...
                        ><a
                          aria-disabled="false"
                          href="https://www.udemy.com/join/signup-popup/?locale=zh_CN&amp;response_type=html&amp;return_link=https%3A%2F%2Fwww.udemy.com%2Fcourse%2Fcomplete-python-bootcamp%2F%3FcouponCode%3DLETSLEARNNOW&amp;source=course_landing_page&amp;ref=&amp;next=%2Fgift%2Fcomplete-python-bootcamp%2F%3FcouponCode%3D24T4MT120424"
                        ...
                        ><button
                          ...
                          class="ud-btn ud-btn-medium ud-btn-ghost ud-heading-sm ud-link-underline ud-link-neutral"
                        >
                          <span class="ud-btn-label">使用优惠券</span>
                        </button>
                      </div>
                      <div>
                        <div
                        ...
                        <div class="redeem-coupon--codes--ZsK6n">
                          ...
                          >
                            ...
                            <button
                              type="button"
                              class="ud-btn ud-btn-large ud-btn-ghost ud-heading-md ud-btn-icon ud-btn-icon-large redeem-coupon--code-icon-button--nwf7w"
                            >
                              <svg
                                aria-hidden="true"
                                focusable="false"
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span class="ud-btn-label">应用</span>
                            </button>
                          </form>
                        </div>
                      </div>
    ...
    <div class="sidebar-container-position-manager">
            ...
            <div class="sidebar-container--introduction-asset--CD5Yt">
              <div class="intro-asset--wrapper--yDCdR">
                ...
                >
                  <button
                    type="button"
                    class="ud-btn ud-btn-large ud-btn-ghost ud-heading-md ud-custom-focus-visible intro-asset--placeholder--5HTOK"
                    aria-label="播放课程预览"
                  >
      ...
      >
        ...
        >
          ...
          ></div>
          <div
            class="slider-menu--slider-menu-container--uGXWY"
            data-client-side-render-only="CSR: slider"
          >
                  ...
                  ><span
                    ...
                    >
                      ...
                      <g
                        ...
                        mask="url(#u62-star-rating-mask--50)"
                        data-purpose="star-filled"
                      >
                        <use
                          xlink:href="#icon-rating-star"
              ...
              <div class="slider-menu--cta-button--xYnRS">
                <div>
                  <button
                    type="button"
                    data-purpose="buy-this-course-button"
                    class="ud-btn ud-btn-large ud-btn-brand ud-heading-md styles--btn--express-checkout--G4Ja4"
                  >
                    <span class="ud-btn-label">立即购买</span>
                  </button>
                </div>
    ...
    <span class="floating-buttons--mark--tHNkN"></span>
    <div class="floating-buttons--floating-buttons-container--5tRWG">
      <div
        class="smart-bar-spacer smart-bar-module--smart-bar-spacer--JTyvD"
        data-testid="smart-bar-spacer"
      ></div>
      <div
        class="floating-buttons--floating-buttons--EB5Yg floating-buttons--hidden--P0B0T"
      >
        <button
          type="button"
          data-target="what-you-will-learn"
          class="ud-btn ud-btn-medium ud-btn-ghost ud-heading-sm"
        >
          <span class="ud-btn-label">概述</span></button
        ><button
          type="button"
          data-target="objective"
          class="ud-btn ud-btn-medium ud-btn-ghost ud-heading-sm"
        >
          <span class="ud-btn-label">课程大纲</span></button
        ><button
          type="button"
          data-target="instructor"
          class="ud-btn ud-btn-medium ud-btn-ghost ud-heading-sm"
        >
          <span class="ud-btn-label">讲师</span></button
        ><button
          type="button"
          data-target="reviews"
          class="ud-btn ud-btn-medium ud-btn-ghost ud-heading-sm"
        >
          <span class="ud-btn-label">审核</span>
        </button>
      </div>
    </div>
    <div class="paid-course-landing-page__body">
      <div class="course-landing-page__main-content">
        <span id="what-you-will-learn" class="in-page-offset-anchor"></span>
        <div
          class="component-margin what-you-will-learn--what-will-you-learn--jsm83"
        >
          <h2 class="ud-heading-xl what-you-will-learn--title--f4aWS">
            您将会学到
          </h2>
          <div
            class="what-you-will-learn--content-spacing--6eP1j show-more-module--container--teP7C"
          >
            <span
              id="u63-show-more--6"
              data-type="checkbox"
                ...
                >
                    ...
                    >
                      ...
                      <div class="ud-block-list-item-content">
                        <span class="what-you-will-learn--objective-item--VZFww"
                          ...
                          problems or personal projects.</span
                        >
                      </div>
                    </div>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <div class="ud-block-list-item-content">
                        <span class="what-you-will-learn--objective-item--VZFww"
                          >You will create a portfolio of Python based projects
                          you can share.</span
                        >
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div class="ud-block-list-item-content">
                        <span class="what-you-will-learn--objective-item--VZFww"
                          ...
                          module and how to work with timestamps!</span
                        >
                      </div>
                    </div>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <div class="ud-block-list-item-content">
                        <span class="what-you-will-learn--objective-item--VZFww"
                          >Learn to use Object Oriented Programming with
                          classes!</span
                        >
                      </div>
                    </div>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <div class="ud-block-list-item-content">
                        <span class="what-you-will-learn--objective-item--VZFww"
                          >Understand complex topics, like decorators.</span
                        >
                      </div>
                    </div>
                  </li>
            ...
            <button
              ...
              aria-label="显示更多"
              data-css-toggle-id="u63-show-more--6"
            >
              <span
        ...
        >
          ...
          <ul class="ud-unstyled-list pill-group-module--pill-group--q7hFg">
            <li class="pill-group-module--pill--4e6tF">
              <a
                href="/topic/python/"
                class="ud-btn ud-btn-large ud-btn-secondary ud-btn-round ud-heading-md"
                ><span class="ud-btn-label">Python</span></a
              >
            </li>
            <li class="pill-group-module--pill--4e6tF">
              <a
                href="/courses/development/programming-languages/"
                class="ud-btn ud-btn-large ud-btn-secondary ud-btn-round ud-heading-md"
                ><span class="ud-btn-label">编程语言</span></a
              >
            </li>
            <li class="pill-group-module--pill--4e6tF">
              <a
                ...
                class="ud-btn ud-btn-large ud-btn-secondary ud-btn-round ud-heading-md"
                ><span class="ud-btn-label">开发</span></a
              >
            </li>
          </ul>
        </div>
        <div
          ...
          class="component-margin incentives--hide-on-desktop--qfrIV"
        >
          <div class="incentives--incentives-container--mJpmM">
            <h2
              class="ud-heading-xl incentives--header--yVAQy"
              data-purpose="header"
            >
              本课程包括：
            </h2>
            <div class="incentives--double-list-container--Hz5Ti">
              <ul class="ud-unstyled-list ud-block-list incentive-list">
                <li>
                  <div
                    class="ud-block-list-item ud-block-list-item-large ud-block-list-item-tight ud-block-list-item-neutral ud-text-md"
                  >
                    <svg
                      aria-hidden="true"
                      focusable="false"
                ...
                <li>
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">
                      <span data-purpose="num-articles">15 篇文章</span>
                    </div>
                  </div>
                </li>
              </ul>
              <ul class="ud-unstyled-list ud-block-list incentive-list">
                ...
                <li>
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">
                      <span data-purpose="incentive-certificate">结业证书</span>
                    </div>
                  </div>
                </li>
              </ul>
        ...
        <div
          class="component-margin curated-for-ufb-notice--curated-for-ufb-notice--JCc4O curated-for-ufb-notice--curated-for-ufb-notice--trust--6FLPs"
          data-client-side-render-only="CSR: curated_for_ub"
        >
          <div
            class="curated-for-ufb-notice--curated-for-ufb-notice-text--pts2N"
          >
            <span class="ud-heading-md" data-purpose="title-text"
              >顶级公司为他们的员工提供这门课程</span
            ><span
              class="ud-text-sm curated-for-ufb-notice--curated-for-ufb-notice-text-body--GLc9h"
              >此课程被选入我们受全球企业信赖的最受好评的课程系列。
              <a class="ud-link-underline">了解更多</a></span
            >
          </div>
          <div
            class="curated-for-ufb-notice--curated-for-ufb-notice-logos--ovTAL"
          >
            <div class="curated-for-ufb-notice--top-companies-logos--iRsv9">
              <img
        ...
        >
          <div
            class="coding-exercise-promotion--coding-exercise-container--kH5xz coding-exercise-promotion--coding-exercise-container-horizontal--lHhRo"
            style=""
          >
            <div
              class="coding-exercise-promotion--coding-exercise-content--f6cJc"
            >
              <h2 class="ud-heading-xl">代码练习</h2>
              <p
                class="ud-text-sm coding-exercise-promotion--coding-exercise-description--koWZ4"
              >
                本课程包括我们更新的代码练习，因此您可以在学习过程中演练所掌握的技能。
              </p>
              <a
                class="ud-btn ud-btn-large ud-btn-link-underline ud-text-sm coding-exercise-promotion--coding-exercise-modal-trigger--e0aUa"
                ><span class="ud-btn-label">查看演示</span></a
              >
            </div>
            <div
              class="coding-exercise-promotion--coding-exercise-image-container--xIt1W"
            >
              <!-- <img
                role="button"
                aria-label="该图像也用作一个按钮，用于跟踪图像放大兴趣区域"
                alt="代码练习示例的图像"
                src="/staticx/udemy/js/webpack/coding-exercises-demo-preview-desktop.2957bed27c3ae43a02824b61ad9cda03.png"
                loading="lazy"
              /> -->
            </div>
          </div>
        ...
        <div class="component-margin">
          ...
          <div data-purpose="course-curriculum">
            <h2
              class="ud-heading-xl curriculum--curriculum-header--vxTrz"
            ...
            <div class="curriculum--curriculum-sub-header--QqY6d">
              <div class="ud-text-sm" data-purpose="curriculum-stats">
                <span class="curriculum--content-length--V3vIz"
                  >23 个章节 • 156 个讲座 •
                  <span
                    >总时长 <span>22&nbsp;小时&nbsp;13&nbsp;分钟</span></span
                  ></span
                >
              </div>
              <button
                ...
                class="ud-btn ud-btn-medium ud-btn-ghost ud-heading-sm"
              >
                <span class="ud-btn-label">展开所有章节</span>
              </button>
            </div>
            <div>
              <div
              ...
              >
                ...
                <div
                  ...
                  aria-labelledby="u62-accordion-panel-title--21"
                  aria-hidden="false"
                  role="group"
                >
                  <div
                    ...
                    >
                      <span class="ud-accordion-panel-title"
                        ...
                        ><span
                          class="ud-text-sm section--hidden-on-mobile---ITMr section--section-content--2mUJ7"
                          data-purpose="section-content"
                          >21 个讲座 • <span>2 小时 2 分钟</span></span
                        ></span
                      >
                    </button>
                  </h3>
                    ...
                    >
                      <span class="ud-accordion-panel-title"
                        ...
                        ><span
                          class="ud-text-sm section--hidden-on-mobile---ITMr section--section-content--2mUJ7"
                          data-purpose="section-content"
                          >7 个讲座 • <span>1 小时 15 分钟</span></span
                        ></span
                      >
                    </button>
                  </h3>
                    ...
                    >
                      <span class="ud-accordion-panel-title"
                        ...
                        ><span
                          class="ud-text-sm section--hidden-on-mobile---ITMr section--section-content--2mUJ7"
                          data-purpose="section-content"
                          >18 个讲座 • <span>2 小时 54 分钟</span></span
                        ></span
                      >
                    </button>
                  </h3>
                    ...
                    >
                      <span class="ud-accordion-panel-title"
                        ...
                        ><span
                          class="ud-text-sm section--hidden-on-mobile---ITMr section--section-content--2mUJ7"
                          data-purpose="section-content"
                          >9 个讲座 • <span>1 小时 40 分钟</span></span
                        ></span
                      >
                    </button>
                  </h3>
                        ...
                        >
                          ...
                          <div class="ud-block-list-item-content">
                            <div>
                              <div class="section--row--MuPRa">
                                <span class="section--item-title--EWIuI"
                                  >Introduction to Warm Up Project
                                  Exercises</span
                                ><button
                                  type="button"
                                  class="ud-btn ud-btn-small ud-btn-ghost ud-btn-round ud-heading-sm ud-btn-icon ud-btn-icon-small ud-btn-icon-round section--hidden-on-mobile---ITMr section--toggle-item-description-button---wEPE"
                    ...
                    >
                      <span class="ud-accordion-panel-title"
                        ...
                        ><span
                          class="ud-text-sm section--hidden-on-mobile---ITMr section--section-content--2mUJ7"
                          data-purpose="section-content"
                          >9 个讲座 • <span>1 小时 21 分钟</span></span
                        ></span
                      >
                    </button>
                  </h3>
        ...
        >
          ...
          <div class="show-more-module--container--teP7C">
            ...
            >
              <div tabindex="-1">
                ...
                >
                  <p>
                    <strong
                      >Become a Python Programmer and learn one of employer's
                      most requested skills of 2023!</strong
                    ><br />
                  </p>
                  <p>
                    This is the
                  ...
                  <p>
                    With <strong>over 100 lectures</strong> and more than 21
                    hours of video this comprehensive course leaves no stone
                    unturned! This course includes quizzes, tests, coding
                    exercises and homework assignments as well as 3 major
                    projects to create a Python project portfolio!
                  </p>
                  <p>
                    <strong
                      >Learn how to use Python for real-world tasks, such as
                      working with PDF Files, sending emails, reading Excel
                      files, Scraping websites for informations, working with
                      image files, and much more!</strong
                    >
                  </p>
                  <p>
                    This course will teach you Python in a practical manner,
                    with every lecture comes a full coding screencast and a
                    corresponding code notebook! Learn in whatever manner is
                    best for you!
                  </p>
                  <p>
                  ...
                  <p>
                    <strong
                      ...
                      will advance your career and increase your knowledge, all
                      in a fun and practical way!</strong
                    >
                  </p>
                </div>
                <div
                  class="styles--audience--a977-"
                  data-purpose="target-audience"
                >
                  <h2 class="ud-heading-xl styles--audience__title--lQoa5">
                    此课程面向哪些人：
                  </h2>
            ...
            <button
              ...
              class="ud-btn ud-btn-medium ud-btn-ghost ud-heading-sm show-more-module--focusable-label--ucIIp"
              aria-label="显示较多描述"
              data-css-toggle-id="u63-show-more--7"
            >
              <span
                ><span class="show-more-module--show-more--ObEu7">显示更多</span
                ><span class="show-more-module--show-less--jkOoQ"
        ...
        >
          ...
          <div class="featured-review--reviewer--LbE9L">
            ...
            /></a>
            <div
              class="featured-review--reviewer-metadata--e4NxL"
              data-purpose="reviewer-metadata"
            >
              <div class="featured-review--title-container--PaemO">
                <div
                  class="ud-heading-md featured-review--title--yj2fb"
                  data-purpose="featured-review-user-title"
                >
                  Ken K.
                </div>
              </div>
              <div class="featured-review--reviewer-stat--Ik1fo">9 门课程</div>
          ...
          <div class="featured-review--rating-container--l-0OU">
            ...
            ><span class="featured-review--review-date--aqAau">4 年前</span>
          </div>
          <div class="show-more-module--container--teP7C">
            <span
              id="u63-show-more--9"
              ...
              <div tabindex="-1">
                ...
                >
                  <div>
                    ...
                    >
                      <div
                        class="course-comparison-module--main-content--ylR3v"
                      >
                        <a
                        ...
                        >
                        <div
                          class="course-comparison-module--course-info--aiTYa"
                        >
                          <div
                      ...
                      <div
                        class="course-comparison-module--image-wrapper---Atz-"
                      >
                        <img
                          src="https://img-c.udemycdn.com/course/50x50/2776760_f176_10.jpg"
                          srcset="
                            https://img-c.udemycdn.com/course/50x50/2776760_f176_10.jpg   1x,
                            https://img-c.udemycdn.com/course/100x100/2776760_f176_10.jpg 2x
                          "
                          alt=""
                          width="64"
                          height="64"
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          srcset="
                            https://img-c.udemycdn.com/course/50x50/2473048_8255_5.jpg   1x,
                            https://img-c.udemycdn.com/course/100x100/2473048_8255_5.jpg 2x
                          "
                          alt=""
                          width="64"
                          height="64"
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          srcset="
                            https://img-c.udemycdn.com/course/50x50/629302_8a2d_2.jpg   1x,
                            https://img-c.udemycdn.com/course/100x100/629302_8a2d_2.jpg 2x
                          "
                          alt=""
                          width="64"
                          height="64"
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          srcset="
                            https://img-c.udemycdn.com/course/50x50/4398404_2f8f_2.jpg   1x,
                            https://img-c.udemycdn.com/course/100x100/4398404_2f8f_2.jpg 2x
                          "
                          alt=""
                          width="64"
                          height="64"
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          srcset="
                            https://img-c.udemycdn.com/course/50x50/543600_64d1_4.jpg   1x,
                            https://img-c.udemycdn.com/course/100x100/543600_64d1_4.jpg 2x
                          "
                          alt=""
                          width="64"
                          height="64"
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          srcset="
                            https://img-c.udemycdn.com/course/50x50/692188_9da7_34.jpg   1x,
                            https://img-c.udemycdn.com/course/100x100/692188_9da7_34.jpg 2x
                          "
                          alt=""
                          width="64"
                          height="64"
        ...
        <div class="component-margin">
          <div data-client-side-render-only="CSR: recommendations">
            <div data-purpose="bundle-wrapper">
              <div
                class="bundle-unit-module--bundle-border--apCJB"
                data-testid="bundle-border"
              >
                <div
                  class="unit-title-module--container--KOSPH unit-title-module--has-title--wMtOa"
                >
                  <div class="unit-title-module--title-container--lt0Qq">
                    <h2
                      class="ud-heading-xl unit-title-module--title--4zm4H"
                      data-us="0"
                      data-purpose="discovery-unit-105216886"
                    >
                      常见购买搭配
                    </h2>
                  </div>
                </div>
                <div class="bundle-unit-module--course-container--y-7Wj">
                  <div class="bundle-unit-module--course-unit-container--anshg">
                    <div
                    ...
                    >
                      <link
                        ...
                        rel="prefetch"
                        href="/course/complete-python-bootcamp/"
                        as="document"
                      />
                      <div
                        class="bundle-unit-module--bundle-course-card--AY6nF course-card-module--container--3oS-F course-card-module--large--AL3kI"
                      ...
                      >
                        <div class="course-card-module--image-container--o-meJ">
                          <img
                            ...
                            alt=""
                            srcset="
                              https://img-c.udemycdn.com/course/240x135/567828_67d0.jpg 1x,
                              https://img-c.udemycdn.com/course/480x270/567828_67d0.jpg 2x
                            "
                            class="course-card-image-module--image--dfkFe course-card-module--course-image--Bwpco browse-course-card-module--image--TAyXN bundle-unit-module--course-unit-image--njy1p"
                            width="260"
                            height="145"
                            loading="lazy"
                          />
                        ...
                        >
                                ...
                                <a
                                  ...
                                  <div class="ud-sr-only" aria-hidden="true">
                                    <span data-testid="seo-headline"
                                      >Learn Python like a Professional Start
                                      from the basics and go all the way to
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--116)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
                          ...
                          >
                            ...
                            >
                              ...
                              <div
                                class="base-price-text-module--price-part---xQlz base-price-text-module--original-price--C6BJt bundle-course-price ud-text-sm"
                                data-purpose="original-price-container"
                              >
                                <div data-purpose="course-old-price-text">
                                  <span class="ud-sr-only">原价</span
                          ...
                          <div
                            class="course-card-module--ribbons-container--k5T9v"
                          >
                            <div
                  ...
                  <div class="bundle-unit-module--course-unit-container--anshg">
                    ...
                    >
                      ...
                      >
                        <div class="course-card-module--image-container--o-meJ">
                          <img
                            src="https://img-c.udemycdn.com/course/240x135/903744_8eb2.jpg"
                            alt=""
                            srcset="
                              https://img-c.udemycdn.com/course/240x135/903744_8eb2.jpg 1x,
                              https://img-c.udemycdn.com/course/480x270/903744_8eb2.jpg 2x
                            "
                            class="course-card-image-module--image--dfkFe course-card-module--course-image--Bwpco browse-course-card-module--image--TAyXN bundle-unit-module--course-unit-image--njy1p"
                            width="260"
                            height="145"
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--117)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
                    ...
                    <div class="bundle-unit-module--plus-icon-wrapper--IRNVW">
                      <svg
                        aria-hidden="true"
                        focusable="false"
                        class="ud-icon ud-icon-large ud-icon-color-neutral"
                      >
                        <use xlink:href="#icon-expand-plus"></use>
                      </svg>
                    </div>
                  </div>
                  <div class="bundle-unit-module--course-unit-container--anshg">
                    ...
                    >
                      ...
                      >
                        <div class="course-card-module--image-container--o-meJ">
                          <img
                            src="https://img-c.udemycdn.com/course/240x135/692188_9da7_34.jpg"
                            alt=""
                            srcset="
                              https://img-c.udemycdn.com/course/240x135/692188_9da7_34.jpg 1x,
                              https://img-c.udemycdn.com/course/480x270/692188_9da7_34.jpg 2x
                            "
                            class="course-card-image-module--image--dfkFe course-card-module--course-image--Bwpco browse-course-card-module--image--TAyXN bundle-unit-module--course-unit-image--njy1p"
                            width="260"
                            height="145"
                            ...
                            <div class="course-card-title-module--title--W49Ap">
                              ...
                              >
                                <a
                                  ...
                                  <div class="ud-sr-only" aria-hidden="true">
                                    <span data-testid="seo-headline"
                                      >Learn Python from zero to advanced by
                                      building real programs to gain the skills
                                      needed to land an entry-level job.</span
                                    ><span data-testid="seo-rating"
                                      >评分：4.7，满分 5 分</span
                                    ><span data-testid="seo-num-reviews"
                                      >68629 条评论</span
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--118)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
                ...
                <div class="bundle-unit-module--footer-container--jjbQt">
                  <div class="bundle-unit-module--price-text-container--JaM2h">
                    <span
                      class="ud-text-lg bundle-unit-module--price-text-prefix--wztoD"
                      >总计：
                    </span>
                    <div
                      class="base-price-text-module--container--Sfv-5"
                      data-purpose="price-text-container"
                    >
                      <div
                        class="base-price-text-module--price-part---xQlz ud-heading-lg"
                        data-purpose="course-price-text"
                      >
                        <span class="ud-sr-only">当前价格</span
                        ><span><span>US$70.97</span></span>
                      </div>
                      <div
                        class="base-price-text-module--price-part---xQlz base-price-text-module--original-price--C6BJt ud-text-md"
                        data-purpose="original-price-container"
                      >
                        <div data-purpose="course-old-price-text">
                          <span class="ud-sr-only">原价</span
                          ><span
                            ><s><span>US$419.97</span></s></span
                          >
                        </div>
                      </div>
                    </div>
                  ...
                  <div data-purpose="add-to-cart">
                    <button
                      type="button"
                      data-testid="add-to-cart-button"
                      class="ud-btn ud-btn-large ud-btn-brand ud-heading-md add-to-cart bundle-unit-module--add-to-cart--IEZfr"
                      style="width: 100%"
                    >
                      全部添加至购物车
                    </button>
        ...
        <div class="component-margin styles--instructors--RDaA9">
          ...
          <div
            class="instructor--instructor--NQkYr"
          ...
          >
            ...
            <div>
              ...
              >
                <a href="/user/joseportilla/">Jose Portilla</a>
              </div>
              ...
              <ul class="ud-unstyled-list ud-block-list">
                <li>
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">4.6 讲师评分</div>
                  </div>
                </li>
                <li>
                  <div
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">1225229 条评论</div>
                  </div>
                </li>
                <li>
                  <div
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">4084201 名学生</div>
                  </div>
                </li>
                <li>
                  <div
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">87 门课程</div>
                  </div>
                </li>
              </ul>
            </div>
            <div class="ud-text-sm instructor--instructor__description--h-aZT">
              <div class="show-more-module--container--teP7C">
                  ...
                  <div tabindex="-1">
                    <div data-purpose="description-content">
                      <p>
                        ...
                        Engineering from Santa Clara University and&nbsp;years
                        of&nbsp;experience as a professional instructor and
                        trainer for Data Science, Machine Learning and Python
                        Programming. He has publications and patents in various
                        fields such as microfluidics,&nbsp;materials science,
                        and data science. Over the course of his career he has
                        developed a skill set in analyzing data and he hopes to
                        use his experience in teaching and data science to help
                        other people learn the power of programming,
                        the&nbsp;ability to analyze data, and the skills needed
                        to present the data in clear and beautiful
                        visualizations. Currently he works as the Head of Data
                        Science for Pierian Training&nbsp;and provides in-person
                        data science and python programming training courses to
                        employees working at top companies, including General
                        Electric, Cigna, SalesForce, Starbucks, McKinsey and
                        many more.&nbsp;Feel free to check out the website link
                        to find out more information about training offerings.
                      </p>
                    </div>
                  </div>
                </div>
                <button
                  type="button"
                  class="ud-btn ud-btn-medium ud-btn-ghost ud-heading-sm show-more-module--focusable-label--ucIIp"
                  aria-label="显示较多讲师相关信息"
                  data-css-toggle-id="u63-show-more--10"
                >
                  <span
                    ><span class="show-more-module--show-more--ObEu7"
                      >显示更多</span
                    ><span class="show-more-module--show-less--jkOoQ"
                      >显示更少</span
                    ></span
          ...
          <div
            ...
            data-purpose="instructor-bio"
          >
            <span class="in-page-offset-anchor" id="instructor-2"></span>
            <div>
              <div
                class="ud-heading-lg ud-link-underline instructor--instructor__title--S9oZ4"
              >
                <a href="/user/pierian-training-2/">Pierian Training</a>
              </div>
              <div class="ud-text-md instructor--instructor__job-title--mEG6s">
              ...
              <ul class="ud-unstyled-list ud-block-list">
                ...
                <li>
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">1234714 条评论</div>
                  </div>
                </li>
                <li>
                  <div
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">4013410 名学生</div>
                  </div>
                </li>
                <li>
                  <div
                  ...
                  >
                    ...
                    <div class="ud-block-list-item-content">94 门课程</div>
                  </div>
                </li>
              </ul>
            </div>
              ...
              <div class="show-more-module--container--teP7C">
                ...
                >
                  <div tabindex="-1">
                    <div data-purpose="description-content">
                      <p>
                        Pierian Training stands as a premier provider in the
                        realms of Data Science and Machine Learning education,
                        offering both in-person and virtual instructor-led
                        training tailored for enterprises. Explore our
                        comprehensive profile to discover a wide range of
                        courses designed to enhance your professional skills and
                        organizational capabilities. Feel free to contact us if
                        you have any questions in the link on our profile!
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div data-purpose="reviews" class="component-margin">
          ...
          >
            ...
            ><span class="ud-heading-xl">4.6 课程评分</span
            ><svg
              aria-hidden="true"
              focusable="false"
            ...
            ><span class="ud-heading-xl">510K 评分</span>
          </div>
          <div
          ...
          >
            ...
            >
              <div class="review--review-heading--YVxxK">
                <div class="review--review-profile--i35qy">
                  <div class="review--review-name-and-rating--T0S-U">
                    <p class="ud-heading-md">Mamatali uulu Azamat B.</p>
                    <div class="review--rating-container--PRpK3">
                      <span
                        ...
                        >
                          ...
                          <g
                            class="star-rating-module--star-filled--FgjdR"
                            mask="url(#u62-star-rating-mask--233)"
                            data-purpose="star-filled"
                          >
                            <use
                              xlink:href="#icon-rating-star"
                ...
                <div class="popper-module--popper--mM5Ie">
                  <button
                    type="button"
                    id="u62-dropdown-trigger--234"
                    aria-expanded="false"
                    tabindex="0"
                    class="ud-btn ud-btn-large ud-btn-ghost ud-heading-md ud-btn-icon ud-btn-icon-large"
                  >
                    <svg
                      aria-label=" 针对 Mamatali uulu Azamat B. 的评论的其他操作"
                      role="img"
                      focusable="false"
                  ...
                  <div
                    id="u62-popper-content--236"
                    aria-labelledby="u62-dropdown-trigger--234"
              ...
              >
                <span
                  >As a beginner in IT, this course has been as valuable as
                  possible. Everything is at the decent level to learn and to
                  dive in.</span
                >
              </div>
              <div class="review--review-feedback-container--kmgJb">
                <div class="review-feedback--feedback-container--4GOIs">
                  <span
                    class="ud-text-xs review-feedback--feedback-label--8RoCm"
                    >有帮助吗？</span
                  >
                  <div class="review-feedback--feedback-actions--EG8FO">
                    ...
                    >
                      <svg
                        aria-label="将 Mamatali uulu Azamat B. 的评论标记为有用"
                        role="img"
                        focusable="false"
                        class="ud-icon ud-icon-small ud-icon-color-neutral"
                      >
                    ...
                    >
                      <svg
                        aria-label="将 Mamatali uulu Azamat B. 的评论标记为没有用"
                        role="img"
                        focusable="false"
                        class="ud-icon ud-icon-small ud-icon-color-neutral"
                      >
            ...
            >
              <div class="review--review-heading--YVxxK">
                <div class="review--review-profile--i35qy">
                  <div class="review--review-name-and-rating--T0S-U">
                    <p class="ud-heading-md">Jason B.</p>
                    <div class="review--rating-container--PRpK3">
                      <span
                        class="star-rating-module--star-wrapper--i1cJH star-rating-module--medium--Lpe62"
                        ><span class="ud-sr-only">评分：4.0，满分 5 分</span
                        ><svg
                          aria-hidden="true"
                          width="100%"
                          height="100%"
                        ...
                        >
                          ...
                          <g
                            class="star-rating-module--star-filled--FgjdR"
                            mask="url(#u62-star-rating-mask--239)"
                            data-purpose="star-filled"
                          >
                            <use
                              xlink:href="#icon-rating-star"
                ...
                <div class="popper-module--popper--mM5Ie">
                  <button
                    type="button"
                    id="u62-dropdown-trigger--240"
                    aria-expanded="false"
                    tabindex="0"
                    class="ud-btn ud-btn-large ud-btn-ghost ud-heading-md ud-btn-icon ud-btn-icon-large"
                  >
                    <svg
                      aria-label=" 针对 Jason B. 的评论的其他操作"
                      role="img"
                      focusable="false"
                      class="ud-icon ud-icon-medium ud-icon-color-neutral"
                    >
                  ...
                  <div
                    id="u62-popper-content--242"
                    aria-labelledby="u62-dropdown-trigger--240"
                    class="popper-module--popper-content--XE9z5"
                    data-testid="popup"
                    style="top: 100%; right: 0px; width: auto"
                  >
              ...
              <div class="review--review-feedback-container--kmgJb">
                <div class="review-feedback--feedback-container--4GOIs">
                  ...
                  <div class="review-feedback--feedback-actions--EG8FO">
                    ...
                    >
                      <svg
                        aria-label="将 Jason B. 的评论标记为没有用"
                        role="img"
                        focusable="false"
                        class="ud-icon ud-icon-small ud-icon-color-neutral"
                      >
            ...
            >
              <div class="review--review-heading--YVxxK">
                <div class="review--review-profile--i35qy">
                  <div class="review--review-name-and-rating--T0S-U">
                    <p class="ud-heading-md">Kathiravan R.</p>
                    <div class="review--rating-container--PRpK3">
                      <span
                        class="star-rating-module--star-wrapper--i1cJH star-rating-module--medium--Lpe62"
                        ><span class="ud-sr-only">评分：4.5，满分 5 分</span
                        ...
                        >
                          ...
                          <g
                            class="star-rating-module--star-filled--FgjdR"
                            mask="url(#u62-star-rating-mask--245)"
                            data-purpose="star-filled"
                          >
                            <use
                              xlink:href="#icon-rating-star"
                ...
                <div class="popper-module--popper--mM5Ie">
                  <button
                    type="button"
                    id="u62-dropdown-trigger--246"
                    aria-expanded="false"
                    tabindex="0"
                    class="ud-btn ud-btn-large ud-btn-ghost ud-heading-md ud-btn-icon ud-btn-icon-large"
                  >
                    <svg
                      aria-label=" 针对 Kathiravan R. 的评论的其他操作"
                      role="img"
                      focusable="false"
                      class="ud-icon ud-icon-medium ud-icon-color-neutral"
                    >
                  ...
                  <div
                    id="u62-popper-content--248"
                    aria-labelledby="u62-dropdown-trigger--246"
                    class="popper-module--popper-content--XE9z5"
                    data-testid="popup"
                    style="top: 100%; right: 0px; width: auto"
                  >
              ...
              >
                <span
                  >It is good course. I learned a lot. I don't say this is a
                  course. It's like solving some math in more alphanumerical way
                  as possible. Now i have slight knowledge about how Python is!
                  Thank you, Jose Portilla, for this wonderful course. Really
                  Appreciated👍.</span
                >
              </div>
              <button
              ...
              >
                <span class="ud-btn-label">显示更多</span>
              </button>
              <div class="review--review-feedback-container--kmgJb">
                <div class="review-feedback--feedback-container--4GOIs">
                  <span
                  ...
                  <div class="review-feedback--feedback-actions--EG8FO">
                    ...
                    >
                      <svg
                        aria-label="将 Kathiravan R. 的评论标记为有用"
                        role="img"
                        focusable="false"
                        class="ud-icon ud-icon-small ud-icon-color-neutral"
                      >
                    ...
                    >
                      <svg
                        aria-label="将 Kathiravan R. 的评论标记为没有用"
                        role="img"
                        focusable="false"
                        class="ud-icon ud-icon-small ud-icon-color-neutral"
                      >
            ...
            >
              <div class="review--review-heading--YVxxK">
                <div class="review--review-profile--i35qy">
                  <div class="review--review-name-and-rating--T0S-U">
                    <p class="ud-heading-md">Jorge G.</p>
                    <div class="review--rating-container--PRpK3">
                      <span
                        class="star-rating-module--star-wrapper--i1cJH star-rating-module--medium--Lpe62"
                        ><span class="ud-sr-only">评分：5.0，满分 5 分</span
                        ...
                        >
                          ...
                          <g
                            class="star-rating-module--star-filled--FgjdR"
                            mask="url(#u62-star-rating-mask--251)"
                            data-purpose="star-filled"
                          >
                            <use
                              xlink:href="#icon-rating-star"
                ...
                <div class="popper-module--popper--mM5Ie">
                  <button
                    type="button"
                    id="u62-dropdown-trigger--252"
                    aria-expanded="false"
                    tabindex="0"
                    class="ud-btn ud-btn-large ud-btn-ghost ud-heading-md ud-btn-icon ud-btn-icon-large"
                  >
                    <svg
                      aria-label=" 针对 Jorge G. 的评论的其他操作"
                      role="img"
                      focusable="false"
                      class="ud-icon ud-icon-medium ud-icon-color-neutral"
                    >
                  ...
                  <div
                    id="u62-popper-content--254"
                    aria-labelledby="u62-dropdown-trigger--252"
                    class="popper-module--popper-content--XE9z5"
                    data-testid="popup"
                    style="top: 100%; right: 0px; width: auto"
                  >
              ...
              >
                <span
                  >Amazing course. Jose was very pleasant to listen to. The
                  course was layered out in a very understandable and
                  easy-to-follow way. Very pleased with this course! Would
                  definitely recommend it for someone who wants to jump into a
                  bootcamp but wants to get their feet wet first.</span
                >
              </div>
              <button
                type="button"
              ...
              <div class="review--review-feedback-container--kmgJb">
                <div class="review-feedback--feedback-container--4GOIs">
                  ...
                  <div class="review-feedback--feedback-actions--EG8FO">
                    ...
                    >
                      <svg
                        aria-label="将 Jorge G. 的评论标记为没有用"
                        role="img"
                        focusable="false"
                        class="ud-icon ud-icon-small ud-icon-color-neutral"
                      >
        ...
        <div class="component-margin">
          <div data-purpose="more-from-instructors-app">
            <div class="styles--more-from-instructor--Ck3VZ">
              ...
              >
                <a href="/user/joseportilla/">Jose Portilla</a> 的更多课程
              </h2>
              <section
                aria-label="轮播"
              ...
              >
                <div
                  ...
                  id="u62-scroll-port--64"
                  aria-live="polite"
                >
                  <div
                    data-index="0"
                    class="carousel-module--scroll-item--QZoY7"
                  >
                    <div
                      class="prefetching-wrapper-module--prefetching-wrapper--h55SO"
                    >
                      <link
                        data-testid="view-prefetch"
                        rel="prefetch"
                        href="/course/the-complete-sql-bootcamp/"
                        as="document"
                      />
                      <div
                      ...
                      >
                        <div class="course-card-module--image-container--o-meJ">
                          <img
                            ...
                            alt=""
                            srcset="
                              https://img-c.udemycdn.com/course/240x135/762616_7693_3.jpg 1x,
                              https://img-c.udemycdn.com/course/480x270/762616_7693_3.jpg 2x
                            "
                        ...
                        >
                            ...
                            <div class="course-card-title-module--title--W49Ap">
                              ...
                              >
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener"
                                  >The Complete SQL Bootcamp: Go from Zero to
                                  Hero
                                  <div class="ud-sr-only" aria-hidden="true">
                                    <span data-testid="seo-headline"
                                      >Become an expert at SQL!</span
                                    ><span data-testid="seo-rating"
                                      >评分：4.7，满分 5 分</span
                                    ><span data-testid="seo-num-reviews"
                                      >219586 条评论</span
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--119)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
                          ...
                          <div class="course-card-details-module--row--jw-lD">
                            ...
                            >
                              <span
                                class="course-card-details-module--row--jw-lD"
                                >总共 9 小时</span
                              ><span
                                class="course-card-details-module--row--jw-lD"
                                >83 个讲座</span
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--120)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div class="course-card-module--image-container--o-meJ">
                          <img
                            src="https://img-c.udemycdn.com/course/240x135/2769460_e60c.jpg"
                            alt=""
                            srcset="
                              https://img-c.udemycdn.com/course/240x135/2769460_e60c.jpg 1x,
                              https://img-c.udemycdn.com/course/480x270/2769460_e60c.jpg 2x
                            "
                            class="course-card-image-module--image--dfkFe course-card-module--course-image--Bwpco browse-course-card-module--image--TAyXN"
                            width="240"
                            height="135"
                            ...
                            <div class="course-card-title-module--title--W49Ap">
                              ...
                              >
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener"
                                  >Python for Machine Learning &amp; Data
                                  Science Masterclass
                                  <div class="ud-sr-only" aria-hidden="true">
                                    <span data-testid="seo-headline"
                                      >Learn about Data Science and Machine
                                      Learning with Python! Including Numpy,
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--121)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--122)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--123)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
                          ...
                          <div class="course-card-ratings-module--row--Lnvpa">
                            <span
                              ...
                              >
                                ...
                                <g
                                  class="star-rating-module--star-filled--FgjdR"
                                  mask="url(#u62-star-rating-mask--124)"
                                  data-purpose="star-filled"
                                >
                                  <use
                                    xlink:href="#icon-rating-star"
        ...
        <div class="component-margin component-border">
          <div class="report-abuse--report-abuse-full-width---jbU4">
            <button
              ...
              data-purpose="report-abuse-link"
            >
              <span class="ud-btn-label">举报滥用行为</span>
            </button>
          </div>
        </div>
      </div>
