      ...
      <div class="show-more-module--content--Rw-xr" style="max-height: 61rem">
        <div tabindex="-1">
          ...
          >
            <div>
              <div
                class="course-comparison-module--course-container--6e7jU flex flex-row py-6 course-container--6e7jU"
                data-purpose="course-container"
              >
                <div
                  class="course-comparison-module--main-content--ylR3v ml-4 max-w-72 flex flex-col main-content"
                >
                  <a
                ...
                <div
                  class="course-comparison-module--image-wrapper---Atz- image-wrapper"
                >
                  <img
                ...
                <div
                  ...
                  class="course-comparison-module--wishlist-content--W2nQI ml-6 wishlist-content"
                >
                  <div>
                    <button
                      type="button"
            ...
            <div>
              ...
              >
                <div
                  class="course-comparison-module--main-content--ylR3v ml-4 max-w-72 flex-4 flex flex-col main-content"
                >
                  <a
                    class="ud-heading-md course-comparison-module--course-title--bShIy course-title"
